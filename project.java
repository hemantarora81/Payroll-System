...
public class project extends JFrame implements ActionListener {
    project(){
        ...
        t3.setFont(new Font("monospaces",Font.PLAIN,12));
        t3.setMnemonic('S');
        t3.setIcon(new ImageIcon(ClassLoader.getSystemResource("icon/SalesRep.png")));
        t3.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_3,ActionEvent.CTRL_MASK));
        ...
        m1.add(t1);//Menu
        m1.add(t3);
        m1.add(t4);//variable s1 is already defined in constructor project()
        mb.add(m1);//MenuBar
        ...
        p1.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_G,ActionEvent.CTRL_MASK));
        rep.add(p1);
        ...
        m8i1.setIcon(new ImageIcon(ClassLoader.getSystemResource("Icon/explorer.jpg")));
   ...
   public void actionPerformed(ActionEvent ae){
       ...
       new TakeAttendence().setVisible(true);
        ...
        System.exit(0);//Displose and this both are same
   }
