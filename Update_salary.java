...
public class Update_salary extends JFrame implements ActionListener,ItemListener  { //Using Multi-Inheritance through Interfaces
    ...
    Update_salary(){
        ...
        JLabel emp = new JLabel("Select Empno");//Primary key
